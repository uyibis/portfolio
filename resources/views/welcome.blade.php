...
<div class="site-wrapper">
        ...
        <div class="header-inner d-flex align-items-start flex-column">
            ...
            <nav>
                <ul class="vertical-menu scrollspy">
                    ...
                    <li><a href="#contactme"><i class="icon-phone"></i>Contact</a></li>
                </ul>
            </nav>
            ...
            <div class="footer mt-auto">
                ...
                <ul class="social-icons list-inline">
                    ...
                    <li class="list-inline-item"><a href="https://twitter.com/SmarpreneurW"><i class="fab fa-twitter"></i></a></li>
        ...
        <section id="skills" class="shadow-blue white-bg padding">
            ...
            <div class="row mt-5">
                ...
                <div class="col-md-6">
                    ...
                    <div class="skill-item">
                        <div class="skill-info clearfix">
                            <h4 class="float-left mb-3 mt-0">JAVA (Android), Python, Sketch</h4>
        ...
        <section id="works" class="shadow-blue white-bg padding">
            ...
            <div class="row portfolio-wrapper">
                ...
                <div class="col-md-4 col-sm-6 grid-item video">
                    <a href="https://tradept.com.ng/">
                        <div class="portfolio-item">
                            <div class="details">
                                <h4 class="title">C bot</h4>
                                <span class="term">Bot, Automation</span>
                            </div>
                            <span class="plus-icon">+</span>
                            <div class="thumb">
                                <img src="images/update/cbot.png" alt="Bot-title" />
                                <div class="mask"></div>
                            </div>
                        </div>
                    </a>
                ...
                <div class="col-md-4 col-sm-6 grid-item creative design">
                    <a href="https://imagecompressor.tradept.com.ng/">
                        <div class="portfolio-item">
                            <div class="details">
                            ...
                            <span class="plus-icon">+</span>
                            <div class="thumb">
                                <img src="images/update/img.PNG" alt="compression-title" />
                                <div class="mask"></div>
                            </div>
                        </div>
                    </a>
                ...
                <div class="col-md-4 col-sm-6 grid-item branding">
                    <a href="https://blavitch.com/">
                        <div class="portfolio-item">
                            <div class="details">
                                <h4 class="title">Blavitch</h4>
                                <span class="term">Branding</span>
                            </div>
                            <span class="plus-icon">+</span>
                            <div class="thumb">
                                <img src="images/update/blavitch.PNG" alt="blavitch-title" />
                                <div class="mask"></div>
                            </div>
                        </div>
                    </a>
                ...
                <div class="col-md-4 col-sm-6 grid-item creative">
                    <a href="https://blavitch.com/">
                        <div class="portfolio-item">
                            ...
                            <span class="plus-icon">+</span>
                            <div class="thumb">
                                <img src="images/update/blavitch1.PNG" alt="blavitch-title" />
                                <div class="mask"></div>
                            </div>
                        </div>
                    </a>
                    ...
                    <a href="#">
                        <div class="portfolio-item">
                            <div class="details">
                                ...
                                <span class="term">Personal</span>
                            </div>
                            <span class="plus-icon">+</span>
                            <div class="thumb">
                                <img src="images/update/portfolio.PNG" alt="Portfolio-title" />
                                <div class="mask"></div>
                            </div>
                        </div>
                    </a>
                ...
                <!-- portfolio item -->
                <div class="col-md-4 col-sm-6 grid-item creative design">
                    <a href="https://geospectraengineering.com/">
                        <div class="portfolio-item">
                            <div class="details">
                                <h4 class="title">Geospectry Engineering</h4>
                                <span class="term">Company, Services</span>
                            </div>
                            <span class="plus-icon">+</span>
                            <div class="thumb">
                                <img src="images/update/company.PNG" alt="company-title" />
                                <div class="mask"></div>
                            </div>
                        </div>
                    </a>
            ...
            <div class="text-center mt-4">
                <a href="#contactme" class="btn btn-default"><i class="fas fa-circle-notch"></i>Contact me</a>
            ...
            <div class="row testimonials-wrapper">
                ...
                <div class="col-md-6">
                    ...
                    <div class="testimonial-item">
                        ...
                        <div class="testimonial-details">
                            <div class="thumb">
                                <img src="images/customer-1.png" alt="customer-name" />
                            </div>
                            <div class="info">
                                <h4>Helen Doe</h4>
                ...
                <div class="col-md-6">
                    ...
                    <div class="testimonial-item">
                        ...
                        <div class="testimonial-details">
                            <div class="thumb">
                                <img src="images/customer-2.png" alt="customer-name" />
                            </div>
                            <div class="info">
                                <h4>Jane Doe</h4>
                                <span>Themeforest customer</span>
    ...
    {{--    <section id="clients" class="shadow-dark background-blue color-white padding-50">
            ...
            <div class="clients-wrapper row">
                ...
                <div class="col-md-3">
                    ...
                    <div class="client-item">
                        <div class="inner">
                            <img src="images/clients/1.png" alt="client-name" />
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    ...
                    <div class="client-item">
                        <div class="inner">
                            <img src="images/clients/2.png" alt="client-name" />
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    ...
                    <div class="client-item">
                        <div class="inner">
                            <img src="images/clients/3.png" alt="client-name" />
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    ...
                    <div class="client-item">
                        <div class="inner">
                            <img src="images/clients/4.png" alt="client-name" />
                        </div>
                    </div>
                </div>
        ...
        <!-- section contact -->
        <section id="contactme"  class="shadow-blue white-bg padding">
            <greeting-message/>
        </section>
        <!-- Modal -->
